...
ax1.plot(x1[:,0],x1[:,1], label='Orbit 3')
ax1.plot([-a,a],[0,0],'o')
ax1.grid()
...
ax2.plot(x2[:,0],x2[:,1],label='Orbit 4')
ax2.plot([-a,a],[0,0],'o')
ax2.grid()
...
ax3.plot(x3[:,0],x3[:,1],label='Orbit 5')
ax3.plot([-a,a],[0,0],'o')
ax3.grid()
...
ax4.plot(x1[:,0],v1[:,0],label='Orbit 3')
ax4.grid()
...
ax5.plot(x1[:,1],v1[:,1],label='Orbit 3')
ax5.grid()
...
ax6.plot(x2[:,0],v2[:,0],label='Orbit 4')
ax6.grid()
ax6.legend(loc='lower right')
ax6.set_xlabel(r'$x$')

ax7 = fig2.add_subplot(grid[1,1])
ax7.plot(x2[:,1],v2[:,1],label='Orbit 4')
ax7.grid()
ax7.legend(loc='lower right')
ax7.set_xlabel(r'$y$')

ax8 = fig2.add_subplot(grid[0,2])
ax8.plot(x3[:,0],v3[:,0],label='Orbit 5')
ax8.grid()
ax8.legend(loc='lower right')
ax8.set_xlabel(r'$x$')

ax9 = fig2.add_subplot(grid[1,2])
ax9.plot(x3[:,1],v3[:,1],label='Orbit 5')
ax9.grid()
...
indexNames=['Orbit 3','Orbit 4','Orbit 5']
