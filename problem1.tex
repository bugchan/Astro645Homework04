...
Prove that this equation has either zero or two roots assuming that the orbit is bound $(E < 0)$ and the potential $V(r)$ is physically realizable (that is: it corresponds to a mass distribution with finite density).
